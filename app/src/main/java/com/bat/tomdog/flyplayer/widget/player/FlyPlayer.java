package com.bat.tomdog.flyplayer.widget.player;
...
import com.bat.tomdog.flyplayer.widget.media.IRenderView;
...
public class FlyPlayer {
    ...
    public FlyPlayer(final Activity activity,View inflate_view) {
        try {
            IjkMediaPlayer.loadLibrariesOnce(null);
            IjkMediaPlayer.native_profileBegin("libijkplayer.so");
            playerSupport=true;
        } catch (Throwable e) {
            Log.e("FlyPlayer", "loadLibraries error", e);
        }
        this.activity=activity;
        screenWidthPixels = activity.getResources().getDisplayMetrics().widthPixels;
        $=new Query(inflate_view);
        videoView = (IjkVideoView) inflate_view.findViewById(R.id.video_view);
...
//                        Toaster.show("download rate:" + extra);
        ...
        seekBar = (SeekBar) inflate_view.findViewById(R.id.app_video_seekBar);
        seekBar.setMax(1000);
        ...
        View liveBox = inflate_view.findViewById(R.id.app_video_box);
        ...
        initHeight=inflate_view.findViewById(R.id.app_video_box).getLayoutParams().height;
        hideAll();
        if (!playerSupport) {
    ...
    /**
     * using constants in FlyPlayer,eg: FlyPlayer.SCALETYPE_FITPARENT
     * @param scaleType
     */
...
//        private final Activity activity;
        ...
        public Query(View inflate_view) {
            this.inflate_view=inflate_view;
        }
        public Query id(int id) {
            view = inflate_view.findViewById(id);
            return this;
        }
     ...
     */
    public FlyPlayer seekTo(int msec, boolean showControlPanle){
    ...
    public FlyPlayer forward(float percent) {
    ...
    public FlyPlayer playInFullScreen(boolean fullScreen){
        if (fullScreen) {
            activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            updateFullScreenButton();
        }
    ...
    public FlyPlayer onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public FlyPlayer onComplete(Runnable complete) {
        this.oncomplete = complete;
        return this;
    }

    public FlyPlayer onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public FlyPlayer onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener){
     ...
     * @return
     */
    public FlyPlayer live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }

    public FlyPlayer toggleAspectRatio(){
        if (videoView != null) {
            videoView.toggleAspectRatio();
        }
        return this;
    ...
    public FlyPlayer onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener){
        this.onControlPanelVisibilityChangeListener = listener;
        return this;
    }
}
